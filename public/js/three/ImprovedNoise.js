...
define(function () {
	...
	var ImprovedNoise = function () {
		...
		var p = [151, 160, 137, 91, 90, 15, 131, 13, 201, 95, 96, 53, 194, 233,
			...
			133, 230, 220, 105, 92, 41, 55, 46, 245, 40, 244, 102, 143, 54, 65,
			25, 63, 161, 1, 216, 80, 73, 209, 76, 132, 187, 208,
			...
			144, 12, 191, 179, 162, 241, 81, 51, 145, 235, 249,
		...
		return {
			...
			noise: function (x, y, z) {
				...
				var A = p[X] + Y, AA = p[A] + Z, AB = p[A + 1] + Z, B = p[X +
					1] + Y, BA = p[B] + Z, BB = p[B + 1] + Z;
