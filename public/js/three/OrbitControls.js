...
define(["three/three"], function (THREE) {
	...
	// Touch on tablet and phones is supported.  Orbit - left mouse / touch:
	// one finger move Zoom - middle mouse, or mousewheel / touch: two finger
	// spread or squish Pan - right mouse, or arrow keys / touch: three finter
	// swipe
		...
		function touchmove( event ) {
			...
			switch ( event.touches.length ) {
				...
				case 1: // one-fingered touch: rotate
					...
					// rotating across whole screen goes 360 degrees around
					constraint.rotateLeft( 2 * Math.PI * rotateDelta.x / element.clientWidth * scope.rotateSpeed );
					// rotating up and down along whole screen attempts to go
					// 360, but limited to 180
					constraint.rotateUp( 2 * Math.PI * rotateDelta.y / element.clientHeight * scope.rotateSpeed );
