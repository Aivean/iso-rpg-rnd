	...
	THREE.FirstPersonControls = function (object, domElement) {
		...
		this.update = function (delta) {
			...
			if (this.heightSpeed) {
				...
				var y = THREE.Math.clamp(this.object.position.y, this.heightMin,
					this.heightMax);
			...
			if (this.moveForward || ( this.autoForward &&
				!this.moveBackward )) this.object.translateZ(
			...
			if (this.lookVertical) this.lat -=
				this.mouseY * actualLookSpeed * verticalLookRatio;
			...
			if (this.constrainVertical) {
				...
				this.phi =
					THREE.Math.mapLinear(this.phi, 0, Math.PI, this.verticalMin,
						this.verticalMax);
